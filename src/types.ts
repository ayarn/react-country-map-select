 ...
 */
export interface CountryMapProps extends Omit<
...
export interface CountryMapSelectProps {
  ...
  /** Name attribute for native form submission. The submitted value is the country code. */
  name?: string;
  /** Mark the field as required. Sets HTML `required` + `aria-required`. */
  required?: boolean;
