...
// @ts-ignore: importing CSS is handled by the bundler
...
const SNIPPET = `import { CountryMapSelect } from 'react-country-map-select'
...
function CopyInstall() {
  ...
  return (
    ...
    >
      ...
      <span className="demo-install-status">{copied ? "Copied!" : "Copy"}</span>
    </button>
  );
}
  ...
  return (
    <div className="demo-shell">
        ...
        <div className="demo-card-row">
          <div className="demo-field">
            ...
            <p className="demo-hint">
              Type to filter by name or ISO code &mdash; e.g. <kbd>in</kbd>,{" "}
              <kbd>jp</kbd>, <kbd>de</kbd>.
            </p>
          </div>
      ...
      <footer className="demo-footer">
        <span>
          Map data &copy;{" "}
          <a href="https://simplemaps.com" target="_blank" rel="noreferrer">
            simplemaps.com
          </a>{" "}
          &middot; MIT licensed
        </span>
